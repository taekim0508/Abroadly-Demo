// Contributors:
// Cursor AI Assistant - TripCard component with rating display
...
const TripCard: React.FC<TripCardProps> = ({ trip, isBookmarked = false, onToggleBookmark }) => {
  return (
    <div className="relative bg-white rounded-lg shadow-md hover:shadow-xl transition-shadow duration-300 overflow-hidden">
      ...
      <Link to={`/trips/${trip.id}`} className="block p-6 pr-14">
        <div className="flex items-start justify-between mb-3">
          <div className="flex items-center">
            <span className="text-3xl mr-3">
              {getTripTypeIcon(trip.trip_type || 'other')}
            </span>
            <div>
